	...
	<div class="col">
		...
		<div class="main_c" id="pjax">
			...
			<div class="sent_content">
				...
				<input type="hidden" id="worldortop_id" value=0>
				<?php
			...
			<p class="please_follow">トップページには、あなたがフォローしたユーザーのポストが表示されます。<br><a href="/world">ここ</a>から興味のあるアカウントを、フォローしよう！</p>
			<script>
				ajax_add_content();
			</script>
		</div><!-- pjax終了 -->
